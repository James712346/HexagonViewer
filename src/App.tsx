...
function App() {
    ...
    return (
        (database == null) ? <PopupWelcome setDatabase={setDatabase} /> : (
            <div>
                <PdfViewer database={database} setArea={setArea} selectedArea={selectedArea} setSelectedArea={setSelectedArea}>
                    <Controls database={database} setDatabase={setDatabase} setSelectedArea={setSelectedArea}/>
                    {(area == null) ? <div /> : (
